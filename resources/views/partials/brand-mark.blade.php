{{-- Stylized Ra (solar disk + rays) & Osiris (atef + mummiform). Optional $class for size. --}}
@php($markClass = $class ?? 'h-11 w-11')
<svg class="{{ $markClass }} shrink-0 drop-shadow-md" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72" fill="none" aria-hidden="true">
    <defs>
