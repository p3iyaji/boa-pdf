...
<div class="flex min-h-screen items-center justify-center px-4 py-12">
    <div class="w-full max-w-md rounded-2xl border border-teal-900/10 bg-stone-50/95 p-8 shadow-2xl shadow-teal-950/20 backdrop-blur-md">
        <div class="mb-8 flex flex-col items-center text-center">
            ...
            <h1 class="font-display text-3xl font-bold tracking-tight text-teal-950">{{ config('app.name') }}</h1>
        ...
        <form method="POST" action="{{ route('authenticate') }}" class="space-y-5">
            ...
            <div>
                <div class="mb-1 flex items-center justify-between gap-2">
                    ...
                    <a href="{{ route('password.request') }}" class="text-sm font-semibold text-amber-700 hover:text-amber-600">Forgot password?</a>
                </div>
            ...
            <p class="text-center text-sm text-teal-900/70">
                ...
                <a href="{{ route('register') }}" class="font-semibold text-amber-700 hover:text-amber-600">Register</a>
            </p>
        </form>
    </div>
</div>
