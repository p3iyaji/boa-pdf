...
<div class="mb-6 md:mb-8">
    <h1 class="font-display text-balance text-2xl font-bold tracking-tight text-teal-950 sm:text-4xl">Welcome back, {{ Auth::user()->name }}.</h1>
...
<div class="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 lg:mb-8 lg:grid-cols-4">
    <a href="{{ route('pdf.index') }}" class="block rounded-xl border border-teal-900/10 bg-white/95 p-4 shadow-md shadow-teal-950/5 ring-1 ring-teal-900/5 transition hover:border-amber-400/40 hover:shadow-lg sm:p-5">
        <p class="text-xs text-teal-800/70 sm:text-sm">Total documents</p>
        <p class="mt-1 text-2xl font-bold tabular-nums text-teal-950 sm:text-3xl">{{ $stats['total'] }}</p>
    </a>
    <div class="rounded-xl border border-teal-900/10 border-t-amber-500/90 bg-white/95 p-4 shadow-md shadow-teal-950/5 sm:p-5">
        ...
        <p class="mt-1 text-2xl font-bold tabular-nums text-teal-950 sm:text-3xl">{{ $stats['merged'] }}</p>
    </div>
    <div class="rounded-xl border border-teal-900/10 border-t-amber-500/90 bg-white/95 p-4 shadow-md shadow-teal-950/5 sm:p-5">
        <p class="text-xs text-teal-800/70 sm:text-sm">Compressed</p>
        <p class="mt-1 text-2xl font-bold tabular-nums text-teal-950 sm:text-3xl">{{ $stats['compressed'] }}</p>
    </div>
    <div class="rounded-xl border border-teal-900/10 border-t-amber-500/90 bg-white/95 p-4 shadow-md shadow-teal-950/5 sm:p-5">
        <p class="text-xs text-teal-800/70 sm:text-sm">Signed</p>
        <p class="mt-1 text-2xl font-bold tabular-nums text-teal-950 sm:text-3xl">{{ $stats['signed'] }}</p>
    </div>
</div>
