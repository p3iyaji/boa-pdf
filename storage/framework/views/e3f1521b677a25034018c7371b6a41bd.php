<?php $__env->startSection('title', 'Reset password - '.config('app.name')); ?>
...
<div class="flex min-h-screen items-center justify-center px-4 py-12">
    <div class="w-full max-w-md rounded-2xl border border-teal-900/10 bg-stone-50/95 p-8 shadow-2xl shadow-teal-950/20 backdrop-blur-md">
        <div class="mb-8 flex flex-col items-center text-center">
            ...
            <h1 class="font-display text-3xl font-bold tracking-tight text-teal-950">Choose a new password</h1>
            <p class="mt-1 text-sm text-teal-800/70">Enter and confirm your new password below</p>
        </div>
        ...
        <form method="POST" action="<?php echo e(route('password.update')); ?>" class="space-y-5">
            ...
            <div>
                <label for="password" class="mb-1 block text-sm font-medium text-teal-950">New password</label>
            ...
            <div>
                <label for="password_confirmation" class="mb-1 block text-sm font-medium text-teal-950">Confirm new password</label>
            ...
            <p class="text-center text-sm text-teal-900/70">
                <a href="<?php echo e(route('login')); ?>" class="font-semibold text-amber-700 hover:text-amber-600">Back to sign in</a>
            </p>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/pauliyaji/Herd/powerhouse/resources/views/auth/reset-password.blade.php ENDPATH**/ ?>