<?php $__env->startSection('title', 'Merge PDFs - '.config('app.name')); ?>
...
<?php if(count($mergeDocuments) < 2): ?>
    <div class="bg-white rounded-xl shadow p-12 text-center">
        <p class="text-gray-500">You need at least two PDFs to merge. <a href="<?php echo e(route('pdf.index')); ?>" class="text-blue-600 hover:underline">Upload some first</a>.</p>
    </div>
<?php else: ?>
    <form method="POST" action="<?php echo e(route('pdf.merge.store')); ?>"
          x-data="mergeForm({ docs: <?php echo \Illuminate\Support\Js::from($mergeDocuments)->toHtml() ?> })"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/pauliyaji/Herd/powerhouse/resources/views/pdf/merge.blade.php ENDPATH**/ ?>