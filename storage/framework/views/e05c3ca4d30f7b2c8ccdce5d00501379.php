<?php $__env->startSection('title', 'Sign - '.$document->original_name); ?>
...
<div class="grid grid-cols-1 gap-6 lg:grid-cols-3"
     x-data="signer({
        streamUrl: <?php echo \Illuminate\Support\Js::from(route('pdf.stream', $document))->toHtml() ?>,
        submitUrl: <?php echo \Illuminate\Support\Js::from(route('pdf.sign.store', $document))->toHtml() ?>,
    ...
    <aside class="space-y-4 rounded-xl bg-white p-5 shadow">
        ...
        <a href="<?php echo e(route('pdf.show', $document)); ?>" class="block text-center text-sm text-gray-500 hover:text-gray-700">Cancel</a>
    </aside>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/pauliyaji/Herd/powerhouse/resources/views/pdf/sign.blade.php ENDPATH**/ ?>